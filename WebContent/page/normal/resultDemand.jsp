...
String type  = new String(request.getParameter("searchtype").getBytes("iso-8859-1"),"utf-8");
String info = new String(request.getParameter("searchInfo").getBytes("iso-8859-1"),"utf-8");
List dlist = stulist.searchDemand(type, info);
...
<div class="layui-layout layui-layout-admin">
  ...
  <tbody>
  	<%
		int i = 0;
		while (iter2.hasNext()) {
			Demand demand = (Demand) iter2.next();
	%>
    <tr>
      <td><%=demand.getDno()%></td>
      <td><%=demand.getCno()%></td>
