...
Company c = adlist.queryoneCompany(cno);
%>
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" >
    <!-- 内容主体区域 -->
    <div class="menu">
<form method="post" action="/DatabaseTask/LoginServlet?method=alterCompany">
<table class="layui-table">
  ...
  <tbody>
    <tr>
      <td>公司ID：</td>
      <td><input type="text" name="cno" readonly="readonly" value="<%out.println(c.getCno()); %>"></td>
    </tr>
    <tr>
      <td>公司名称：</td>
      <td><input type="text" name="cname" value="<%out.println(c.getCname()); %>"></td>
    </tr>
    <tr>
      <td>公司地址:</td>
      <td><input type="text" name="address" value="<%out.println(c.getAddress()); %>"></td>
    </tr>
    <tr>
    <td> </td>
