...
Demand d = adlist.queryoneDemand(dno);
%>
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body" >
    <!-- 内容主体区域 -->
    <div class="menu">
<form method="post" action="/DatabaseTask/LoginServlet?method=alterDemand">
<table class="layui-table">
  ...
  <tbody>
    <tr>
      <td>需求ID:</td>
      <td><input type="text" name="dno"  readonly="readonly" value="<%out.println(d.getDno()); %>"></td>
    </tr>
    <tr>
      <td>公司ID：</td>
      <td><input type="text" name="cno" value="<%out.println(d.getCno()); %>"></td>
    </tr>
    <tr>
      <td>公司名称：</td>
      <td><input type="text" name="cname" value="<%out.println(d.getCname()); %>"></td>
    </tr>
    <tr>
      <td>岗          位：</td>
      <td><input type="text" name="post" value="<%out.println(d.getpost()); %>"></td>
    </tr>
    <tr>
      <td>截止时间: </td>
      <td><input type="text" name="time" value="<%out.println(d.getTime()); %>"></td>
    </tr>
    <tr>
      <td>招聘人数:</td>
      <td><input type="text" name="needperson" value="<%out.println(d.getNeedperson()); %>"></td>
    </tr>
    <tr>
    <td> </td>
